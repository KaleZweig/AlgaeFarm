...
#mainLogo{position:absolute; top:5vw; right:10vw; width:40vw; height:auto; }
#firstBox{color:white; font-size:4vw; text-decoration:none; position:absolute; top:49vw; left:55vw;}
#secondBox{color:white; font-size:4vw; text-decoration:none; position:absolute; top:78vw; left:15vw;}
#thirdBox{color:white; font-size:4vw; text-decoration:none; position:absolute; top:105vw; left:55vw;}
#fourthBox{color:white; font-size:4vw; text-decoration:none; position:absolute; top:134vw; left:26vw;}
#fifthBox{color:white; font-size:4vw; text-decoration:none; position:absolute; top:162vw; left:55vw;}
...
<a id="secondBox"> More information <br /> on the project</a>
<hr />
<img src="blueprint.jpg" class="jpg" id="leftImage">
<a id="thirdBox"> The <br /> Design</a>
<hr />
<img src="algae.jpg" id="rightImage">
<a id="fourthBox"> All about <br /> algae</a>
<hr />
<img src="oil.jpg" id="leftImage">
<a id="fifthBox"> The issues with <br /> petrolium fuels</a>
